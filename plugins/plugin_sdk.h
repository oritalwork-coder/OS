 ...
 * 
 * This header defines the standard interface that all plugins must implement.
 * Each plugin is a dynamically loaded shared object (.so) that exports these
 * functions to integrate with the pipeline system.
 */
